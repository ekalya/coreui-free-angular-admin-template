...
export class DynamicListPlusComponent implements OnInit, OnChanges {
  ...
  add() {
    this.action = 'CREATE';
    this.listActionMenuClick.emit({object: null, action: 'CREATE'});
    this.showForm = true;
  }
  ...
  details() {
    ...
    this.listActionMenuClick.emit({object: this.listItems[this.listItems.indexOf(this.selectedObject)], action: 'DETAILS'});
  ...
  update() {
    ...
    this.listActionMenuClick.emit({object: this.listItems[this.listItems.indexOf(this.selectedObject)], action: 'UPDATE'});
    this.model = this.cloneObj(this.selectedObject);
    this.showForm = true;
  }
  ...
  delete() {
    ...
    this.listActionMenuClick.emit({object: this.listItems[this.listItems.indexOf(this.selectedObject)], action: 'DELETE'});
  }
