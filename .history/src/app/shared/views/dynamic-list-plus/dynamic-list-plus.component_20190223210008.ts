...
export class DynamicListPlusComponent {
  ...
  @Output() public sendModelToFormEmitter2: EventEmitter<any> = new EventEmitter<any>();
  dynamicFormsBridge: DynamicFormsBridge = new DynamicFormsBridge();
  dynamicFormsBridge2: DynamicFormsBridge = new DynamicFormsBridge();
  selectedObject: any;
  obj: any = {};
  first: number = 0;
  showForm: boolean;
  ...
  modelFormSaveAction2(form: FormGroup) {
    console.log(form.value);
  }
  ...
  showDialog() {
    this.dynamicFormsBridge2.dynamicFormActions = DynamicFormActions.Read;
    this.displayDialog = true;
    this.sendModelToFormEmitter2.emit(this.obj);
  }
}
