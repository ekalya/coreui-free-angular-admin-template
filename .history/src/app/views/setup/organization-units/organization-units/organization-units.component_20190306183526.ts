...
details(node: TreeNode) {
    this.model = this.orgUnits[this.orgUnits.indexOf(this.selectedOrgUnit)] as OrganizationUnit;
    this.action = 'READ';
    this.hideCloseButton = false;
...
edit(node: TreeNode) {
    ...
    console.log(orgunits[orgunits.indexOf(this.selectedOrgUnit)]);
    console.log(orgunits.indexOf(this.selectedOrgUnit));
    this.model = this.orgUnits[this.orgUnits.indexOf(this.selectedOrgUnit)] as OrganizationUnit;
    this.action = 'UPDATE';
    this.hideCloseButton = false;
    this.hideSaveButton = false;
