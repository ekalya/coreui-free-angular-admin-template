...
addChild(node: TreeNode) {
    ...
    console.log(this.selectedUnit as OrganizationUnitType);
    this.organizationUnitTypesService.update(this.selectedUnit as OrganizationUnitType).subscribe(response => {
...
deleteChild(node: TreeNode) {
    this.selectedUnit.parent.children = [];
    this.messageService.add({severity: 'success', summary: 'Created successfully', detail: 'Successfully Created'});
}
