...
export class BankListComponent implements OnInit  {
  ...
  actionMenuClick(action: string) {
    if (action === 'CREATE') {
      this.router.navigate(['/setup/users/userdetails'], {queryParams: {user: JSON.stringify(new Bank()), mode: action}});
    } else if (action === 'EDIT') {
      ...
      this.router.navigate(['/setup/users/userdetails'], {queryParams: {user: JSON.stringify(this.selectedBank), mode: action}});
