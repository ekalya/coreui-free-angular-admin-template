...
export class BankDetailsUIService {
  bankBranchesUIService: BankBranchDetailsUIService;
  constructor() {
    this.bankBranchesUIService = new BankBranchDetailsUIService();
  }
  getMetadata() {
    ...
    const metadata: InputControlBase<any>[] = [
      ...
      new InputControlDynamicList({
        key: 'branches',
        label: 'Branches',
        placeholder: 'Branches List',
        value: [],
        model: new Bank(),
        controls: this.bankBranchesUIService.getMetadata(),
        columns: this.bankBranchesUIService.getColumns(),
        order: 7
      })
    ];
