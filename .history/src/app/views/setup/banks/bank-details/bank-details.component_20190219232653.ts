...
export class BankDetailsComponent implements OnInit {
  ...
  branchFormEmitterEventValues(form: FormGroup) {
    ...
    bankBranch.code = this.form.value.code;
    bankBranch.name = this.form.value.name;
    bankBranch.physicalAddress = this.form.value.physicalAddress;
    bankBranch.postalAddress = this.form.value.postalAddress;
    bankBranch.telephone = this.form.value.telephone;
    bankBranch.email = this.form.value.email;
    this.model.branches.push(bankBranch);
  }
