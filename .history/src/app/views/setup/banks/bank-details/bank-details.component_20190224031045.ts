...
export class BankDetailsComponent implements OnInit {
  ...
  submitResetActionMenuClick(action: ButtonActions) {
    ...
    if (action as ButtonActions === ButtonActions.SUBMIT as ButtonActions) {
        console.log('inside process submitt...........');
        if (this.dynamicFormsBridge.dynamicFormActions as DynamicFormActions === DynamicFormActions.Create as DynamicFormActions) {
          console.log('create.............');
        ...
        } else if (this.dynamicFormsBridge.dynamicFormActions as DynamicFormActions === DynamicFormActions.Update as DynamicFormActions) {
          console.log('update.............');
