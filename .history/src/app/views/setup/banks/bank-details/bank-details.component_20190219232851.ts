...
export class BankDetailsComponent implements OnInit {
  ...
  branchFormEmitterEventValues(form: FormGroup) {
    selectedBranch.code = this.form.value.code;
    selectedBranch.name = this.form.value.name;
    selectedBranch.physicalAddress = this.form.value.physicalAddress;
    selectedBranch.postalAddress = this.form.value.postalAddress;
    selectedBranch.telephone = this.form.value.telephone;
    selectedBranch.email = this.form.value.email;
  }
