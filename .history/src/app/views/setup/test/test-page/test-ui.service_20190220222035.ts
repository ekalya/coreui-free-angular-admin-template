...
import { InputControlMultiSelect, InputControlPassword, InputControlPickList, InputControlTextBox, InputControlDataType, InputControlDropdown } from '../../../../core/controls';
...
export class TestUIService {
  ...
  getUIControls() {
    ...
    const controls: InputControlBase<any>[] = [
